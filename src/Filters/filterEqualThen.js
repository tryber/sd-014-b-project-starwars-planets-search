...
const filterEqualThen = (data, method) => {
  const { column, value } = method;

  const dataFilter = () => {
    if (column === 'population') {
      return data
        .filter((e) => e.population === value);
    }
    if (column === 'orbital_period') {
      return data
        .filter((e) => e.orbital_period === value);
    }
    if (column === 'diameter') {
      return data
        .filter((e) => e.diameter === value);
    }
    if (column === 'rotation_period') {
      return data
        .filter((e) => e.rotation_period === value);
    }
    if (column === 'surface_water') {
      return data
        .filter((e) => e.surface_water === value);
    }
  };
...
export default filterEqualThen;
